...
contract Test {
    ...
    struct Wager {
        ...
        int price; // The price (of bitcoin for example), at the time of the wager
    }
    ...
    event WagerResolved(uint256 indexed wagerId, Result result, int price);
    event Predicted(
