...
const makeRequestToOracle = async () => {
  ...
  console.log('🚀 ~ makeRequestToOracle ~ privateKey:', privateKey)
  ...
  const rpcUrl = process.env.ETHEREUM_SEPOLIA_RPC_URL // fetch mumbai RPC URL
  console.log('🚀 ~ makeRequestToOracle ~ rpcUrl:', rpcUrl)
